    ...
    <div class="mx-2 mt-2 mb-5">
     ...
     <div class="modal-content mx-auto bg-white p-3">
        ...
        <div class="body">
            ...
            <div v-for="month in yearMonths" :key="month.id" class="form-check">
...
export default {
    ...
    methods:{
        ...
        tvetMonth(){
            this.showModal('tvetMonth',this.feeMonth.tvet)
        },
        ...
        addMonths(){
            ...
            else if(this.modalType==='tvetMonth'){
                this.feeMonth.tvet=this.months
            }
            this.modalState=false
             this.months=[]
        },
        ...
        //    if(!this.feeMonth.tvet.length)
        //       this.errors.push('TVET program month can\'t be empty.')

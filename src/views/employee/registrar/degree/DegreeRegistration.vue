...
export default {
  ...
  methods: {
    ...
    admissionDetail(admissionData) {
      this.studentInfo.degree_department_id =
        admissionData.degree_department_id;
      ...
      try {
        ...
        if (response.status === 201) {
          ...
          this.$store.commit(
            ...
            "You have registered a Degree student successfully"
          );
          ...
          this.$store.commit(
            "registrar/setResultNotifier",
            "You have already registered this Student"
          );

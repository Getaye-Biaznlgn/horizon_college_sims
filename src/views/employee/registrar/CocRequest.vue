  ...
  <base-card>
    ...
    <div id="cocRequest" class="m-5">
      ...
      <div class="sr-only d-flex justify-content-end mt-1 px-5">
        <div>
          <h5><u>ቁጥር:</u>{{ "_________________" }}</h5>
          <br />
          <h5>
            <u
              >ቀን
      ...
      <div class="sr-only cocTitel ms-5 mt-3">
        ...
        <h5>
          ኮሌጃችን ከልህቀት ኤጀንሲው በተሰጠው የምዘና ማእከልነት እውቅና መሰረት በተሰጠው የሙያ ደረጃዎች ተመዛኞችን
          መዝግበናል።
        </h5>
        <h5>በዚህ መሰረት፦</h5>
      </div>
      ...
      <div v-if="!cocRequestDatas.length" class="mt-3 ms-5 mx-5">
        Ther is no students registered for this COC
      </div>

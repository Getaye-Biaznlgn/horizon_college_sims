...
<div class="row mt-2">
    <div class="mb-3 col-lg-5" :class="{warning:v$.studentInfo.dob.$error}">
...
<div class="row mt-3">
 ...
 <div class="mb-3 col-lg-3" :class="{warning:v$.contact_relationship.$error}">
  ...
  <select class="form-select form-select-sm" aria-label=".form-select-sm example" v-model="degreeDptId">
...
if(response.status === 200){
  console.log('degree student detail',response.data)
    ...
    this.studentInfo.contact_tel = response.data.contact_tel
    ...
    this.contact_relationship = response.data.contact_relationship
      ...
      this.emergency_address.region = response.data.emergency_address.region
         ...
         this.emergency_address.kebele = response.data.emergency_address.kebele
          this.emergency_address.house_no = response.data.emergency_address.house_no
           ...
           //educational data
            ...
            this.degreeDptId = response.data.degree_department_id
            this.programId = response.data.program_id
            this.year_no = response.data.current_year_no
            var scolar = response.data.fully_scholarship
            if(Number(scolar) === 1){
                this.fully_scholarship = true
            }
       ...
       async savePersonalInfo(){
         ...
         this.uploadPersonalInfo = true
           ...
           var response= await apiClient.put('api/update_degree_student_personal_info/'+this.student_id,this.studentInfo)
            if(response.status === 200){
       ...
       async saveEducationalData(){
         ...
         this.isUploading2 = true
           ...
           var response= await apiClient.put('api/update_degree_student_educational_info/'+this.student_id,edudationData)
            if(response.status === 200){
              this.isSuccessed = true
            this.isFaild = false
                console.log(response.data)
          ...
          async seveAdmissionData(){
            ...
            this.resultNotifier2 = ''
             ...
             var admissionData = {}
           admissionData.degree_department_id = this.degreeDptId
           ...
           var response= await apiClient.put('api/update_degree_student_admission_info/'+this.student_id,admissionData)
            if(response.status === 200){
                console.log(response.data)
                this.isSuccessed = true
            this.isFaild = false

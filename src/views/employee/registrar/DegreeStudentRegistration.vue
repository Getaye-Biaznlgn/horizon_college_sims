...
<div><input class="form-control form-control-sm w-100" type="text" aria-label=".form-control-sm example" v-model="studentInfo.reciept_no"></div>
</div>
</div>
<form @submit.prevent>
<base-card>
...
<div class="sex mt-4"><span class="me-2"><strong>Sex:-</strong></span></div>
  ...
  <input class="form-check-input p-2" type="radio" name="birthplace" value="male" id="male" checked v-model="studentInfo.sex">
  <label class="form-check-label" for="male">
    Male
  </label>
</div>
    <div class="form-check mt-4 me-3">
  <input class="form-check-input p-2" type="radio" name="birthplace" value="female" id="female" v-model="studentInfo.sex">
  <label class="form-check-label" for="female">
    Fmale
  </label>
</div>
...
<div class="mb-3 col-sm-3">
    ...
    <input type="text" class="form-control form-control-sm" id="country" v-model="studentInfo.birth_country">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="region" class="form-label">Region</label>
    <input type="text" class="form-control form-control-sm" id="region" v-model="studentInfo.birth_region">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="zone" class="form-label">Zone</label>
    <input type="text" class="form-control form-control-sm" id="zone" v-model="studentInfo.birth_zone">
  </div>
</div>
<div class="row mt-3">
   <div class="mb-3 col-sm-4">
    <label for="subcity" class="form-label">District/Sub city</label>
    <input type="text" class="form-control form-control-sm" id="subcity" v-model="studentInfo.birth_subcity">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="kebele" class="form-label">Kebele</label>
    <input type="text" class="form-control form-control-sm" id="kebele" v-model="studentInfo.birth_kebele">
  </div>
</div>
<div class="mb-3 col-sm-4">
    <label for="birthdate" class="form-label"><strong>Date of Birth:-</strong></label>
    <input type="text" class="form-control form-control-sm" id="birthdate" v-model="studentInfo.date_of_birth">
  </div>
  <div class="mt-3"><strong>Current residential address:-</strong></div>
  <div class="row mt-3">
  <div class="mb-3 col-sm-4">
    <label for="country" class="form-label">District</label>
    <input type="text" class="form-control form-control-sm" id="country" v-model="studentInfo.current_district">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="region" class="form-label">Kebele</label>
    <input type="text" class="form-control form-control-sm" id="region" v-model="studentInfo.current_kebele">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="zone" class="form-label">House No</label>
    <input type="text" class="form-control form-control-sm" id="zone" v-model="studentInfo.current_house_no">
  </div>
  </div>
  <div class="mb-4 col-sm-4">
    <label for="phoneNo" class="form-label"><strong>Phone Number</strong></label>
    <input type="tel" class="form-control form-control-sm" id="phoneNo" v-model="studentInfo.current_phone_no">
  </div>
  <div class="d-flex">
<div><span class="me-2"><strong>Marital Status:-</strong></span></div>
<div class="form-check me-3">
  <input class="form-check-input ms-4 p-2" type="radio" name="marritalstatus" id="married" value="married" checked v-model="studentInfo.marital_status">
  <label class="form-check-label ms-2" for="married">
    Married
  </label>
</div>
<div class="form-check me-3">
  <input class="form-check-input ms-4 p-2" type="radio" name="marritalstatus" id="single" value="single" v-model="studentInfo.marital_status">
...
<div class="row mt-3">
  <div class="mb-3 col-sm-4">
    ...
    <input type="text" class="form-control form-control-sm" id="name" v-model="studentInfo.contacted_person_name">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="relation" class="form-label">Relationship</label>
    <input type="text" class="form-control form-control-sm" id="relation" v-model="studentInfo.contacted_person_relation">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="relativesregion" class="form-label">Region</label>
    <input type="text" class="form-control form-control-sm" id="relativesregion" v-model="studentInfo.contacted_person_region">
  </div>
  </div>
  <div class="row mt-3">
  <div class="mb-3 col-sm-4">
    <label for="town" class="form-label">Town</label>
    <input type="text" class="form-control form-control-sm" id="town" v-model="studentInfo.contacted_person_town">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="woreda" class="form-label">Woreda/Subcity</label>
    <input type="text" class="form-control form-control-sm" id="woreda" v-model="studentInfo.contacted_person_worda">
  </div>
  <div class="mb-3 col-sm-4">
    <label for="relativesckebele" class="form-label">Kebele</label>
    <input type="text" class="form-control form-control-sm" id="relativesckebele" v-model="studentInfo.contacted_person_kebele">
  </div>
  </div>
   <div class="mb-4 col-sm-4">
    <label for="relativesphoneNo" class="form-label">Phone Number</label>
    <input type="tel" class="form-control form-control-sm" id="relativesphoneNo" v-model="studentInfo.contacted_person_phone_no">
  </div>
</base-card>
...
<base-card>
  ...
  <div class="mb-4 col-sm-4 mt-3">
    ...
    <input type="text" class="form-control form-control-sm" id="departmenttype" v-model="studentInfo.department">
  </div>
...
<div class="form-check ms-5 me-3">
  <input class="form-check-input ms-2 p-2" type="radio" name="financee" id="selfsupport" value="selfsupport" checked v-model="studentInfo.finance_support">
  <label class="form-check-label ms-2" for="selfsupport">
    Self-Support
  </label>
</div>
<div class="form-check me-3">
  <input class="form-check-input ms-4 p-2" type="radio" name="financee" id="govt" value="govt" v-model="studentInfo.finance_support">
  <label class="form-check-label ms-2" for="govt">
    Geovernment
  </label>
</div>
<div class="form-check me-3">
  <input class="form-check-input ms-4 p-2" type="radio" name="financee" id="relative" value="relative" checked v-model="studentInfo.finance_support">
  <label class="form-check-label ms-2" for="relative">
    Relative
  </label>
</div>
<div class="form-check me-3">
  <input class="form-check-input ms-4 p-2" type="radio" name="financee" id="nongovt" value="nongovt" v-model="studentInfo.finance_support">
...
<div class="form-check ms-4 mt-4 me-1">
  <input class="form-check-input ms-4 p-2" type="radio" name="financee" id="other" value="other" v-model="studentInfo.finance_support">
  <label class="form-check-label ms-2" for="other">
    Other(specify)
  </label>
</div>
<span class="mt-4 col-sm-4">
<input class="form-control form-control-sm" type="tex" name="financee" id="othersource" v-model="studentInfo.finance_otherstated_support">
</span>
</div>
  </base-card>
  <div class="d-flex justify-content-end p-4">
  <button @click="addNewStudent" class="btn ms-auto">REGISTER</button>
  </div>
  </form>
    </div>
    </div>
...
export default {
  data() {
    ...
    methods: {
      async addNewStudent(){
console.log('properties of new student')
...
try{
  ...
  if(response.status === 200){
   ...
   var previousDegreeStudent = this.$store.getters['student/degreeStudents']
    previousDegreeStudent.push(response.data)
    this.$store.commit('setDegreeStudent',previousDegreeStudent)
  }
  else{
    throw 'error'
  }

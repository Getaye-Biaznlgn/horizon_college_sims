    ...
    <div class="px-0 mx-0 mt-0">
        ...
        <div class="cards d-flex position-relative mx-2">
            <div class=" bg-cyan-light flex-fill shadow p-2 rounded rounded-lg">
                ...
                <span class="fw-bold d-block text-center">{{statistics.total_degree_student}}</span>
            </div>
             ...
             <div class=" bg-cyan-light flex-fill ms-3 shadow p-2 rounded rounded-lg">
                ...
                <span class="fw-bold d-block text-center">{{statistics.new_degree_student}}</span>
            </div>
            
             <div class=" bg-cyan-light flex-fill ms-3 shadow p-2 rounded rounded-lg">
                <span class="d-block text-center fs-2"><i class="fas fa-user pe-2 fw-bold"></i></span>
                <span class="d-block text-center small my-1 mx-4">Total Regular</span>
                <span class="fw-bold d-block text-center">{{statistics.total_degree_regular_student}}</span>
            </div>
             <div class=" bg-cyan-light flex-fill ms-3 shadow p-2 rounded rounded-lg">
                <span class="d-block text-center fs-2"><i class="fas fa-user pe-2 fw-bold"></i></span>
                <span class="d-block text-center small my-1">Total Extension</span>
                <span class="fw-bold d-block text-center">{{statistics.total_degree_extension_student}}</span>
            </div>
        </div>
        <div class="row  mb-3 mt-4">
          <div class="col-lg-6">
               <base-card>
                ...
                <a @click="$router.push({name:'DegreeHeadStudent', query:{program:'regular'}})" role="button" class="nav-link fw-bold py-0 pe-0">SEE ALL</a>
              </div>
                 <table>
                     ...
                     <tbody>
                         <tr v-for="(student,index) in regularStudents" :key="student.id">
                             ...
                             <th>{{student.sex?.substring(0,1)}}</th>
                             <th>{{student.year_no}}</th>
                         </tr>
                     </tbody>
                 </table>
          ...
          <div class="col-lg-6">
               <base-card>
                ...
                <a @click="$router.push({name:'DegreeHeadStudent', query:{program:'extension'}})" role="button" class="nav-link fw-bold py-0 pe-0">SEE ALL</a>
              </div>
                 <table>
                     <thead class="bg-secondary text-white">
                         <tr>
